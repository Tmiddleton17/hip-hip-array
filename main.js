...
for (let i = 0; i < mixedSignNumbers.length; i++) {
  if (mixedSignNumbers[i] % 2 === 0 || mixedSignNumbers[i] % 2 === 0 && mixedSignNumbers[i] <= 0) {
    console.log('The even numbers are at index: ${i} and is the number: ${mixedNumbers[i]}');
  }
}

// Challenge 5
// Remove two values from the beginning and one value from the end of the following array, simply by deleting them in the following line. Then console.log out each value individually.
const symmetricalCapitals = ['A', 'H', 'I', 'M', 'O', 'T', 'U', 'V', 'W', 'X'];
...
const fibonacciNumbers = [0,1, 1, 2, 3, 5, 8, 13, 'abcd', 'abcd'];
...
challenge8.push(2);
challenge8.push(3);
challenge8.unshift(4);
challenge8.unshift(5);
...
const studentsSlice = students.slice();
...
const third = primaries.contact(secondaries);
